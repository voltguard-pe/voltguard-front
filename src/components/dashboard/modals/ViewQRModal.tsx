  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          {/* Removimos paddings innecesarios del contenedor gris/blanco para que el QR se pegue a los bordes de su tarjeta */}
          <div className="rounded-3xl bg-white p-2 shadow-sm border border-slate-100">
            <div id="qr-print-area" className="relative mx-auto max-w-[220px] p-1">
              <QRCode
                value={qrUrl}
                size={220}
                level="H"
              ...
              {/* El Logo en el centro exacto del QR de la interfaz */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white p-1 rounded-xl shadow-md border border-slate-100 size-11 flex items-center justify-center">
                  <img
                    src="/voltguard.png"
                    alt="Voltguard Logo"
                    className="object-contain size-full"
